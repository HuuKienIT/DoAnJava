...
public class pickdate extends JPanel {
	...
	protected String iconFile = "pickate.gif";
	...
	public pickdate(int month, int day, int year) {
		super();
...
//        final JButton pickate = new JButton("bam vo");
//        pane.add(pickate);
//        pickate.setPreferredSize(new Dimension(30, 24));
//        pickate.setMargin(new Insets(0,0,0,0));
//        pickate.addActionListener(new ActionListener() {
//            public void actionPerformed(ActionEvent e) {
//                dp.setDate(testDate.getText());
//                dp.popupShow(pickate);
//            }
//        });
