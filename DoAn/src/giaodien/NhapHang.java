...
public class NhapHang extends JPanel {
	...
	public NhapHang(NhanVienModel nv) {
		...
		setLayout(null);
	 	...
	 	txtTenKH.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "T\u00EAn Nh\u00E0 Cung C\u1EA5p", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
